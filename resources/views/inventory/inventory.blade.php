...
<body>
    ...
    <script>
        ...
        const PRODUCT_TYPES = 
        {
            BEAUTY: 
            {
                ITEMS: ['Eye Shadow Palette', 'Lip Gloss', 'Nail Polish Set', 'Highlighter and Blush (2 in 1)', 'Beauty Sponge', 'Honey Body Spray'],
                SIZES: 
                {
                    'Eye Shadow Palette': ['1 Pack', '2 Pack'],
                    'Lip Gloss': ['5ml', '10ml'],
                    'Nail Polish Set': ['S', 'M', 'L'],
                    'Highlighter and Blush (2 in 1)': ['1 Pack', '2 Pack'],
                    'Beauty Sponge': ['S', 'L'],
                    'Honey Body Spray': ['500ml']
                }
            },

            HEALTH: 
            {
                ITEMS: ['Vitamin B(ee)', 'Bee Pollen', 'Propolis Capsules', 'Jar of Honey', 'Bee Pollen Powder'],
                SIZES: {
                    'Vitamin B(ee)': ['60', '120'],
                    'Bee Pollen': ['120g'],
                    'Propolis Capsules': ['30'],
                    'Jar of Honey': ['S', 'L'],
                    'Bee Pollen Powder': ['250g']
                }
            },

            HAIRCARE: 
            {
                ITEMS: ['Honey Shampoo', 'Honey Conditioner', 'Honey Hair Mask', 'Honey Hair Mousse', 'Honey-infused Hair Oil'],
                SIZES: 
                {
                    'Honey Shampoo': ['500ml'],
                    'Honey Conditioner': ['500ml'],
                    'Honey Hair Mask': ['100ml'],
                    'Honey Hair Mousse': ['440ml'],
                    'Honey-infused Hair Oil': ['60ml']
                }
            },

            SKINCARE: 
            {
                ITEMS: ['Honey Face Mask', 'Honey Moisturiser', 'Honey Cleanser', 'Honey Lip Balm', 'Honey Sunscreen SPF50'],
                SIZES: 
                {
                    'Honey Face Mask': ['50ml'],
                    'Honey Moisturiser': ['50ml'],
                    'Honey Cleanser': ['100ml'],
                    'Honey Lip Balm': ['10g'],
                    'Honey Sunscreen SPF50': ['50ml']
                }
            },

            BODYCARE: 
            {
                ITEMS: ['Honey Lotion', 'Honey Shower Gel', 'Honey Roll-On Deodorant', 'Honey Body Scrub', 'Honey Body Cream'],
                SIZES: 
                {
                    'Honey Lotion': ['250ml'],
                    'Honey Shower Gel': ['300ml'],
                    'Honey Roll-On Deodorant': ['50ml'],
                    'Honey Body Scrub': ['200ml'],
                    'Honey Body Cream': ['250ml']
                }
            },
            
            MERCH: 
            {
                ITEMS: ['HiveMind Logo Hoodie', 'HiveMind Beenie', 'HiveMind T-Shirt', 'HiveMind Enamel Pin', 'HiveMind Bee Socks'],
                SIZES: 
                {
                    'HiveMind Logo Hoodie': ['S', 'M', 'L', 'XL'],
                    'HiveMind Beenie': ['One Size'],
                    'HiveMind T-Shirt': ['S', 'M', 'L', 'XL'],
                    'HiveMind Enamel Pin': ['One Size'],
                    'HiveMind Bee Socks': ['One Size']
                }
            },

            HOME: 
            {
                ITEMS: ['Honey Home Perfume Spray', 'Honey Scented Candle', 'Honey Fragrance Sticks', 'Honey Refill Fragrance Sticks', 'HiveMind Beeswax Wraps'],
                SIZES: 
                {
                    'Honey Home Perfume Spray': ['100ml'],
                    'Honey Scented Candle': ['300g'],
                    'Honey Fragrance Sticks': ['120ml'],
                    'Honey Refill Fragrance Sticks': ['120ml'],
                    'HiveMind Beeswax Wraps': ['Set of 3']
                }
            }
        };
