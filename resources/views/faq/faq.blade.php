                    ...
                    <div class="flex justify-center">
                        <div class="p-4 rounded-lg shadow-md bg-stone-100 dark:bg-stone-800 dark:shadow-stone-900 w-[80%] sm:w-1/2 md:w-1/3">
                            <div class="mb-4">
                                ...
                                <p class="text-lg">You can make a donation through The British Bee Charity <a href="https://www.paypal.com/donate/?hosted_button_id=VZZ8YQ994DXUE" class="text-lg text-blue-500 dark:text-amber hover:underline">donation page</a>.</p>
                            </div>
                            <div class="mb-4">
                    ...
                    <div class="flex justify-center">
                        <div class="p-4 rounded-lg shadow-md bg-stone-100 dark:bg-stone-800 dark:shadow-stone-900 w-[80%] sm:w-1/2 md:w-1/3">
                            <ul class="list-disc list-inside text-left">
                                <li class="mb-2">
                                    <a href="https://www.projectapism.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">Project Apis m.</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://www.nwf.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">National Wildlife Federation</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://xerces.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">The Xerces Society</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://www.pollinator.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">Pollinator Partnership</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://www.beesfordevelopment.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">Bees for Development</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://www.planetbee.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">Planet Bee Foundation</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://thebeeconservancy.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">The Bee Conservancy</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://www.beeandbutterflyfund.org/" class="text-lg text-blue-500 dark:text-amber hover:underline">The Bee & Butterfly Habitat Fund</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://karmahoneyproject.com/" class="text-lg text-blue-500 dark:text-amber hover:underline">Karma Honey Project</a>
                                </li>
                                <li class="mb-2">
                                    <a href="https://britishbeecharity.com/" class="text-lg text-blue-500 dark:text-amber hover:underline">The British Bee Charity</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="p-4 rounded-lg shadow-md bg-stone-100 dark:bg-stone-800 dark:shadow-stone-900 w-[80%] sm:w-1/2 md:w-1/3">
                            <div class="mb-4">
                                ...
                                <p class="text-lg"> Please press the cancel order button on the <a href="{{ route('orders') }}" class="text-lg text-blue-500 dark:text-amber hover:underline">orders</a> page to request a cancellation.</p>
                            </div>
                            <div class="mb-4">
