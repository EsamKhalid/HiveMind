        ...
        <div class="flex justify-center m-4">
            ...
            <div
                ...
                <div class="flex justify-between transition-all duration-1000 flex-col-reverse lg:flex-row">
                    ...
                    <div
                        class="bg-white dark:bg-yellow-500 shadow-md p-5 rounded-lg w-full lg:w-1/4 hidden lg:flex lg:flex-col justify-between transition-colors duration-1000">
                    ...
                    @if(count($basketItems) > 0)
                        <div
                            ...
                            <div id="checkoutbuttonbox"
                                ...
                                <div class=" mobileViewAddressLine hidden flex-col lg:hidden">
                    ...
                    <!--BASKET ITEMS-->
                    <div
                        class="justify-between h-[90%] w-full mt-5 lg:w-3/4 lg:mt-0 transition-all duration-1000 flex flex-col">
                        @if(count($basketItems) === 0)
                            <div
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex flex-col flex-shrink">
                                                    ...
                                                    <div class="flex mt-1 mx-auto lg:ml-0 lg:mr-5 lg:mb-3 lg:mt-0">
                                                        ...
                                                        <p class="m-3 h-fit mt-1 text-xs sm:text-sm md:text-base lg:text-lg">{{$basketItem->quantity}}</p>
                                                        <!-- increase button -->
