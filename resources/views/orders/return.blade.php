...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-4xl mx-auto mt-6 mb-12 p-6 bg-white shadow-lg rounded-lg">
        <form action="{{ route('orders.return.submit', $order->id) }}" method="POST">
            ...
            <select name="return_reason" required class="w-full p-2 border rounded">
                ...
                <option value="Wrong Item Sent">No longer needed</option>
                <option value="Not as Described">Missing parts or accessories</option>
                <option value="Other">Description on website was not accurate</option>
                <option value="Not as Described">Performance or quality not adequate</option>
