        ...
        <div class="flex justify-center m-4">
            <div class="w-full bg-white dark:bg-stone-950 p-8 rounded-lg shadow-md">
                ...
                <div class="flex flex-row space-x-3 justify-evenly">
                    @if(!$user)
                        <form id='guestDetails' action="{{ route('checkout.storeGuest') }}" method="post"
                            class="bg-stone-500 p-3 rounded-lg space-y-5 h-full flex flex-col justify-between w-[50%] lg:w-[30%]">
                            @csrf
                            @auth
                                <div class="flex flex-col items-start mb-4">
                                    ...
                                    <input type="text" name="first_name" id="first_name" value="{{$user->first_name}}" readonly
                                        class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                                <div class="flex flex-col items-start mb-4">
                                ...
                                <div class="flex flex-col items-start mb-4">
                                    <label for="email_address" class="block text-stone-600 dark:text-white mb-2">Email
                                        Address</label>
                                    <input type="text" name="email_address" id="email_address" value="{{$user->email_address}}"
                                        readonly class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                                <div class="flex flex-col items-start mb-4">
                                    <label for="phone_number" class="block text-stone-600 dark:text-white mb-2">Phone
                                        Number</label>
                            ...
                            @else
                                <div class="flex flex-col items-start mb-4">
                                    <label for="first_name" class="block text-stone-600 dark:text-white mb-2">First Name</label>
                                    <input type="text" name="first_name" id="first_name" value="{{$guest->first_name}}" required
                                        class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                                <div class="flex flex-col items-start mb-4">
                                    <label for="last_name" class="block text-stone-600 dark:text-white mb-2">Last Name</label>
                                    <input type="text" name="last_name" id="last_name" value="{{$guest->last_name}}" required
                                        class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                                <div class="flex flex-col items-start mb-4">
                                    <label for="email_address" class="block text-stone-600 dark:text-white mb-2">Email
                                        Address</label>
                                    <input type="text" name="email_address" id="email_address" value="{{$guest->email_address}}"
                                        required class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                                <div class="flex flex-col items-start mb-4">
                                    <label for="phone_number" class="block text-stone-600 dark:text-white mb-2">Phone
                                        Number</label>
                                    <input type="text" name="phone_number" id="phone_number" value="{{$guest->phone_number}}"
                                        required class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" />
                                </div>
                            ...
                            @endauth
                            <a class="p-3 bg-green-500 w-fit cursor-pointer ml-auto rounded-lg"
                                onclick="showNextForm('guestDetails','address')">NEXT</a>
                        </form>
                        <form id='address' action="{{ route('checkout.storeAddress') }}" method="post"
                            class="hidden bg-stone-500 p-3 rounded-lg justify-between max-h-[80%] h-fit text-xs sm:text-sm md:text-base lg:text-lg w-[40%]">
                            @csrf
                            @if($address != null)
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="street_address"
                                        class="xl:w-full mx-auto block text-black dark:text-white  lg:dark:text-white mb-1 transition-colors duration-1000">Street
                                        Address</label>
                                ...
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="city"
                                        class="xl:w-full mx-auto block text-black dark:text-white lg:dark:text-white mb-1 transition-colors duration-1000">City</label>
                                    <input type="text" name="city" id="city" value="{{$address->city}}" required
                                        class="w-[90%] xl:w-full mx-auto p-1 xl:p-3 mb-1 xl:mb-2 border border-stone-300 rounded dark:bg-stone-200 transition-colors duration-1000" />
                                </div>
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="county"
                                        class="xl:w-full mx-auto block text-black dark:text-white lg:dark:text-white mb-1 transition-colors duration-1000">County</label>
                                    <input type="text" name="county" id="county" value="{{$address->county}}" required
                                        class="w-[90%] xl:w-full mx-auto p-1 xl:p-3 mb-1 xl:mb-2 border border-stone-300 rounded dark:bg-stone-200 transition-colors duration-1000" />
                                </div>
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="country"
                                        class="xl:w-full mx-auto block text-black dark:text-white lg:dark:text-white mb-1 transition-colors duration-1000">Country</label>
                                    <input type="text" name="country" id="country" value="{{$address->country}}" required
                                        class="w-[90%] xl:w-full mx-auto p-1 xl:p-3 mb-1 xl:mb-2 border border-stone-300 rounded dark:bg-stone-200 transition-colors duration-1000" />
                                </div>
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="post_code"
                                        class="xl:w-full mx-auto block text-black dark:text-white lg:dark:text-white mb-1 transition-colors duration-1000">Post
                                        Code</label>
                                    <input type="text" name="post_code" id="post_code" value="{{$address->post_code}}" required
                                        class="w-[90%] xl:w-full mx-auto p-1 xl:p-3 mb-1 xl:mb-2 border border-stone-300 rounded dark:bg-stone-200 transition-colors duration-1000" />
                                </div>
                                <input type="hidden" name="type" value="shipping" />
                                <div class="flex justify-center mt-auto">
                            ...
                            @endif
                            <a class="p-3 bg-green-500 w-fit cursor-pointer ml-auto rounded-lg"
                                onclick="showNextForm('address','guestDetails')">BACK</a>
                        </form>
                    @else
                        <form action="{{ route('checkout.storeAddress') }}" method="post"
                            class="bg-stone-500 p-3 rounded-lg justify-between max-h-[80%] h-fit text-xs sm:text-sm md:text-base lg:text-lg w-[40%]">
                            @csrf
                            @if($address != null)
                                <div class="flex flex-col items-start mb-1 xl:mb-2">
                                    <label for="street_address"
