...
<body class="bg-yellow-50 dark:bg-stone-950">
    ...
    <div class="flex justify-center">
        <div class=" flex justify-center mt-[10%] flex-col lg:flex-row px-5 pb-7 pt-5 dark:bg-stone-800 rounded-lg">
            <div class="flex justify-center pr-5">
                <img class="w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] size-full hover:scale-105 transition-all duration-500 dark:brightness-[80%] dark:hover:brightness-90 rounded-lg"
            ...
            <div class="inline-block justify-center size-[35vh] mt-10 text-stone-800 dark:text-yellow-200">
                ...
                <form action="{{ route('basket.add') }}" method="post">
                    ...
                    <button type="submit"
                        class="bg-yellow-400 text-white py-6 px-9 rounded-md hover:bg-yellow-500 dark:dark:bg-stone-700 dark:hover:text-amber transition-all duration-500">
                        Add to Basket
                    </button>
                </form>
    ...
    <div id="REVIEW_MODAL"
        ...
        <div class="bg-white p-5 rounded-lg w-[400px] shadow-md">
            ...
            <form action="{{ route('review.storeProductReview', $product->id) }}" method="POST">
                @csrf
                <div class="mb-4">
