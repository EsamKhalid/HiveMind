        ...
        <form method="Post" action={{ route('admin.view-user.update', ['id' => $user->id])}}>
            ...
            <div
                ...
                <div>
                    ...
                    <input type="text" name="firstname" id="firstnameform" class="hidden ml-5 text-2xl text-black"
            ...
            <div
                ...
                <p>Last name: </p>
                <div>
                    <input type="text" name="lastname" id="lastnameform" class="hidden ml-5 text-2xl text-black"
            ...
            <div
                ...
                <div>
                    ...
                    <input type="text" name="email" id="emailform" class="hidden ml-5 text-2xl text-black"
            ...
            <div
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phoneform" class="hidden ml-5 text-2xl text-black"
