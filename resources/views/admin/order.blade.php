    ...
    <main>
        <div class="flex justify-center m-4">
            <div class="card bg-yellow-50 dark:bg-stone-700 p-6 rounded-lg shadow-md text-center w-1/2">
                <p class="text-4xl mb-6 dark:text-yellow-400 font-bold">Stock Order for: {{ $product->product_name }}</p>
                ...
                <form action="{{ route('admin.order') }}" method="post" id="stock-order-form" class="mt-4">
                    ...
                    <div class="flex flex-col items-center mb-4">
                        ...
                        <input type="number" name="stock_quantity" class="w-1/2 p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" required min="1" />
                    </div>

                    <div class="flex flex-col items-center mb-4">
                        <label for="lead_time" class="block text-stone-600 dark:text-white mb-2">Lead Time (in days)</label>
                        <input type="number" name="lead_time" class="w-1/2 p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" required min="0" />
                    </div>
                    ...
                    <div class="flex flex-col items-center mb-4">
                        ...
                        <select name="supplier_id" id="supplier_id" class="w-1/2 p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" required>
