            ...
            <section class="contact-options h-3/4 grid grid-cols-1 md:grid-cols-2 gap-6 p-8 bg-white dark:bg-stone-900 transition-all duration-1000">
                ...
                <div class="card bg-yellow-50 dark:dark:bg-stone-700 p-6 rounded-lg shadow-md text-center">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" id="contact-us-form">
                        ...
                        @endif
                        <textarea name="enquiry" placeholder="Your Message (max 255 characters)" class="w-full p-3 mb-4 border border-gray-300 rounded dark:bg-stone-300" rows="4" required></textarea>
