            ...
            <!-- contact details -->
                ...
                <div class="card bg-yellow-50 dark:dark:bg-stone-700 p-6 rounded-lg shadow-md text-center">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" id="contact-us-form">
                        @csrf
                        @if($user != null)
                        <input type="text" name="name" value="{{$user->first_name}}" class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" required>
                        <input type="email" name="email_address" value="{{$user->email_address}}" class="w-full p-3 mb-4 border border-stone-300 rounded dark:bg-stone-300" required>
                        @else
