...
>
    <div class="container mx-auto flex flex-wrap justify-between py-8 dark:bg-stone-800 transition-colors duration-1000">
        <!-- adding first third of footer (left side), includes contact information / link to contact page -->
        <div class="w-full md:w-1/3 flex flex-col items-start mb-4 md:mb-0 transition-colors duration-1000">
