            ...
            <div class="px-6 py-4 h-full ">
                ...
                <div class="flex flex-col justify-between  h-full">
                    <div id="top-half-sidebar" class="flex flex-col dark:text-white">
                        ...
                        <a class="text-3xl my-4 p-3 w-full text-nowrap dark:hover:bg-stone-800 hover:bg-yellow-200 justify-between flex" href={{ route('notifications') /*notifications*/}}><p>Notifications</p><i class="fa-solid fa-inbox text-yellow-500 text-4xl"></i></a>
                        ...
                        <a class="text-3xl my-4 p-2 w-full text-nowrap dark:hover:bg-stone-800 hover:bg-yellow-200 justify-between flex" href={{route('admin-dashboard' /*suppliers*/)}}><p>Suppliers</p> <i class="fa-solid fa-boxes-packing text-yellow-500 text-4xl"></i></a>
