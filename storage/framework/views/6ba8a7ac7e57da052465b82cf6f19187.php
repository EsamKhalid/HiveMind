...
<body>
    <div class="overflow-hidden">
        ...
        >
            ...
            >
                <img
                    src="<?php echo e(asset('../Images/HiveMind Logo.png')); ?>"
                    alt="logo"
            ...
            <ul class="text-center list-none inline-flex">
                <li class="flex justify-center size-full">
                    <a href="<?php echo e(route('products')); ?>">Shop Us</a>
                </li>
            ...
            <div class="logoTextCenter NavLogoContainer">
                <a href="<?php echo e(route('basket')); ?>" class="fas fa-shopping-basket fa-2xl"></a>
                <a href="<?php echo e(route('account')); ?>" class="far fa-user fa-solid fa-2xl"></a>
            </div>
        </nav>
        <div class="cdwa-right h-[20px] w-screen border-b-2 border-amber"></div>
    </div>
</body>
<?php /**PATH C:\Users\taran\Documents\GitHub\HiveMind\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>