<footer style="background-image:url(/Images/honeycomb2.png);">
    <div class="container mx-auto flex flex-wrap justify-evenly items-start">
        ...
        <div class="w-full md:w-1/3">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="text-lg text-blue-500 hover:text-blue-600">Contact Page</a>
        </div>
...
</footer><?php /**PATH C:\Users\taran\Documents\GitHub\HiveMind\resources\views/layouts/footer.blade.php ENDPATH**/ ?>